...
/**
 * A filter for verifying the format of command messages.
 */
public final class CommandMessageFilter extends BaseMessageFilter {

    private CommandMessageFilter() {
        // prevent instantiation
    }

    /**
     * Checks whether a given command message contains all required properties.
     * <p>
